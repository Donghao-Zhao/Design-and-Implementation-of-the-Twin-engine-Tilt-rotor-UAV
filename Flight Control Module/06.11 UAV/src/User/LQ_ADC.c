...
uint16_t ADC_Get(uint8_t num)
{
    ...
    {
      case 0:
        return ADC_Mid(ADC0, ADC0_SE8, ADC_12bit);
        break;
        
      case 1:
        return ADC_Mid(ADC0, ADC0_SE9, ADC_12bit);
        break;
      ...
      case 4:
        return ADC_Mid(ADC1, ADC0_SE14, ADC_12bit);
        break;
        
      case 5:
        return ADC_Mid(ADC1, ADC0_SE15, ADC_12bit);
        break;
        
      case 6:
        return ADC_Mid(ADC1, ADC0_SE16, ADC_12bit);
        break;
      ...
      case 9:
        return ADC_Mid(ADC1, ADC1_DM1, ADC_12bit);
        break;
        
      case 10:
        return ADC_Mid(ADC0, ADC0_DM1, ADC_12bit);
        break;
...
void Test_ADC(void)
{
    ...
    OLED_CLS();
    printf("ADC 测试例程");
    printf("ADC0_SE8  =8,        PTB0      母板上的AD0 \n  ");  
    printf("ADC0_SE9  =9,        PTB1      母板上的AD1 \n ");
    printf("ADC0_SE12 =12,       PTB2      母板上的AD2 \n ");
    printf("ADC0_SE13 =13,       PTB3      母板上的AD3 \n ");
    ...
    printf("ADC1_DM1  =20,       ADC1_DM1  母板上的AD9 \n ");
    printf("ADC0_DM1  =20,       ADC0_DM1  母板上的AD10 \n");
...
void Test_ADC(void)
{
    ...
    while(1)
    {
        ...
        batv10 = (uint16_t)(ADC_Get(10)*0.806);
            ...
            printf("\r\n/AD9***********************%5d mv\r\n ",batv9);
            sprintf(txt,"AD9:%5d mv ",batv9);
            TFTSPI_P8X8Str(1,12,txt,u16RED,u16BLUE);
            
            printf("\r\n/AD10***********************%5d mv\r\n ",batv10);
            sprintf(txt,"AD10:%5d mv ",batv10);
            TFTSPI_P8X8Str(1,13,txt,u16RED,u16BLUE); 
