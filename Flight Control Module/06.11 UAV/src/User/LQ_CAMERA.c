...
{  
    ...
    //初始化DMA采集       通道4        PTD9-PTD15           目的地址      触发信号 每次一个BYTE  长度    下拉上升沿触发
    DMA_PORTx2BUFF_Init (DMA_CH4, (void *)&PTD_BYTE1_IN,(void*)Image_Data, PTE6, DMA_BYTE1, (IMAGEW ), DMA_rising_down); 
    /* 摄像头初始化结束 */
